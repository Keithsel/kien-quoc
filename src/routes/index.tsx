...
import { InstructionModal } from '~/components/game';

export default function Home() {
  const [showInstructions, setShowInstructions] = createSignal(false);

  return (
    <main class="min-h-screen bg-linear-to-br from-red-900 via-red-800 to-amber-900 flex flex-col items-center justify-center p-8 text-white relative overflow-hidden">
      ...
      <div class="relative z-10 text-center max-w-2xl">
        ...
        <div class="grid grid-cols-4 gap-4 mb-12">
          <div class="flex flex-col items-center gap-2 p-4 bg-white/10 rounded-xl backdrop-blur-sm">
            ...
            <span class="text-sm">6 Vùng miền</span>
          </div>
          <div class="flex flex-col items-center gap-2 p-4 bg-white/10 rounded-xl backdrop-blur-sm">
            <Users class="w-8 h-8 text-amber-300" />
            <span class="text-sm">2-6 Người chơi</span>
          </div>
          <div class="flex flex-col items-center gap-2 p-4 bg-white/10 rounded-xl backdrop-blur-sm">
