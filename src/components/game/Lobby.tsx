...
import { MAX_TEAMS } from '~/config/game';
import { InstructionModal } from '~/components/game/modals';
...
export default function OnlineLobby(props: LobbyProps) {
  ...
  return (
    <main class="min-h-screen bg-linear-to-br from-red-50 to-amber-50 flex flex-col p-8">
      {/* Header */}
        ...
        <Show when={game()}>
          <div class="bg-white rounded-2xl shadow-lg p-6 mt-6">
            <h2 class="text-lg font-bold text-gray-700 mb-4 flex items-center gap-2">
              <Users class="w-5 h-5" />
              Đội đã tham gia ({connectedTeams().length}/{MAX_TEAMS})
            </h2>
            <div class="space-y-2">
