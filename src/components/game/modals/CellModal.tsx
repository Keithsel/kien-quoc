...
import { cellEffects, cellTypeLabels, cellTypeIcons } from '~/components/game/play';
    ...
    >
      <div class="bg-white rounded-2xl shadow-2xl max-w-md w-full mx-4 p-6" onClick={(e) => e.stopPropagation()}>
        ...
        <div class="flex items-center gap-4 mb-6">
          <div class="w-12 h-12 rounded-xl bg-linear-to-br from-red-500 to-amber-500 flex items-center justify-center">
