...
import { getTurnModifierEffect, type ModifierEffect } from '~/config/events';
...
export function GameProvider(props: GameProviderProps) {
  ...
  // Calculate modifier effect for current turn
  const modifierEffect = createMemo(() => {
    return getTurnModifierEffect(currentTurn(), randomModifiers());
  });
