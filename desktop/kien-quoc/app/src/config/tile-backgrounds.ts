...
// Updated to match new board layout
export const TILE_BACKGROUNDS: Record<string, string> = {
  'cell-0-0': '/tiles/bach-khoa.jpg', // Đại học Bách khoa
  'cell-0-1': '/tiles/viet-tri.jpg', // Khu CN Việt Trì
  'cell-0-2': '/tiles/lang-son.jpg', // Cửa khẩu Lạng Sơn
  'cell-0-3': '/tiles/vien-han-lam.jpg', // Viện Hàn lâm
  'cell-1-0': '/tiles/tay-nguyen.jpg', // Tây Nguyên
  'cell-1-3': '/tiles/da-nang.jpg', // Cảng Đà Nẵng
  'cell-2-0': '/tiles/song-hong.jpg', // Đồng bằng sông Hồng
  'cell-2-3': '/tiles/tan-thuan.jpg', // KCX Tân Thuận
  'cell-3-0': '/tiles/thu-duc.jpg', // Khu đô thị Thủ Đức
  'cell-3-1': '/tiles/cuu-long.jpg', // Đồng bằng sông Cửu Long
