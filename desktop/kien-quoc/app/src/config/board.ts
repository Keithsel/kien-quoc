...
export const BOARD_CELLS: BoardCell[] = [
  ...
  { id: 'cell-0-3', row: 0, col: 3, name: 'Khu CN Việt Trì', type: 'shared', indices: ['economy', 'environment'] },
  ...
  { id: 'cell-2-3', row: 2, col: 3, name: 'KCX Tân Thuận', type: 'shared', indices: ['science', 'economy'] },
