...
import { useIndexHealth, usePhaseChecks } from '~/lib/hooks';
import { INDEX_NAMES, INDEX_LABELS, RESOURCES_PER_TURN } from '~/config/game';
import { INDEX_ICONS, INDEX_COLORS } from '~/components/game/shared';
...
export default function LeftSidebar(props: LeftSidebarProps) {
  ...
  const game = useGame();
  const { isActionPhase, isResultPhase } = usePhaseChecks();
  const { dangerIndices, indexChanges, hasDanger } = useIndexHealth();
                ...
                >
                  <div class="flex items-center justify-between mb-1">
                    ...
                    <div class="flex items-center gap-1">
                      ...
                      {/* Change indicator */}
                      <Show when={isResultPhase() && indexChanges()[idx] !== undefined && indexChanges()[idx] !== 0}>
                        <span
